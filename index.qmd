...
Mathematical models help combine data to inform infectious disease policy for both ongoing monitoring and outbreak response.
...
This allows different data sources to be combined reliably, and for specialist knowledge to be included, whilst remaining flexible.
...
Such systems could provide the timely, rigorous, and collaborative evidence needed to effectively inform policy during both ongoing monitoring and outbreak response.
