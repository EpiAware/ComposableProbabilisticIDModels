...
Other novel data sources have been shown to provide useful information but have not been integrated into most models used to inform policy.
...
During the COVID-19 pandemic, models integrating case counts, prevalence surveys, severity data, and hospital bed occupancy provided evidence that supported policy decisions [@birrell2024; @ons2020cis; @davies21_transmissibility_b117], yet these models were not used during the 2022 mpox outbreak as contact structure and behaviour needed explicit representation and these models were not adapted to include this [@Endo2022-ij].
...
Multi-model efforts synthesise cross-domain expertise by combining forecasts or scenario projections from multiple teams (e.g., [@brisson20_impacthpv;@cramer22_unitedstatescovid]) and have been shown to improve predictive accuracy [@reich22_collaborativehubs;@howerton23_evaluationuscovid], yet teams rarely collaborate on elements of their models despite shared goals.
...
In practice, while rigorous policy-relevant modelling is possible it usually comes at the cost of the flexibility needed for cross-domain collaboration and timely evidence generation.
