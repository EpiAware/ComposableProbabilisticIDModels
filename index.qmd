...
@fig-case-studies highlights component reuse across the case studies: Mishra et al. reuses the AR(2) component from the ARIMA example, the `EpiNow2` replication reuses the complete ARIMA model, and Chatzilena et al. demonstrates an alternative Susceptible-Infected-Recovered (SIR) infection process.
