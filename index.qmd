...
This approach enables building block style model construction, analysing all data sources and processes together whilst retaining the modularity of separate model components.
...
A key strength of our proposed approach, demonstrated through our three case studies, is its modular design, which enables faster model development and component reuse whilst allowing comparison of modelling assumptions without significant reimplementation.
...
This modularity enables interdisciplinary collaboration, as domain experts can contribute specialised components encoding their knowledge without needing to understand other components.
Such a design would also support both routine forecasting through seasonal refinement of components [@Reich2019-flusight; @Cramer2021-hub-dataset; @cdcrtestimates] and outbreak response through adaptation of models to novel pathogens using the same framework.
...
The explicit component structure and validation tools also make our approach well-suited for large language model assisted model construction [@aygun2025ai].
...
A final limitation is the learning curve required to adopt this compositional pattern, though researchers can embed elements within their existing models with minimal understanding of the overall architecture.
...
The explicit structure and validation tools of our DSL should enable large language models to reason about model design and propose structural adaptations more easily and with less room for error.
