...
As outlined in @sec-approach, key strengths of building on `Turing.jl` [@fjelde2025turin] include mature submodel support for nesting models within models, extensive inference algorithm choices, and integration with the wider Julia ecosystem through `Distributions.jl` [@JSSv098i16] and other packages.
...
Profiling tools have historically been difficult to use because probabilistic programming abstractions obscure the relationship between source code and runtime behaviour, though recent DynamicPPL refactoring has aimed to improve this.
