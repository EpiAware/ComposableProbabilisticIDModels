...
We then present a proof of concept to explore how these requirements can be met in practice, investigating the feasibility and limitations of composable model construction that combines the flexibility of chaining models with the statistical rigour of joint models through composable epidemiological components.
...
This approach enables building block style probabilstic model construction, analysing all data sources and processes together whilst retaining the modularity of separate model components.
We demonstrated our approach conceptually using models from published epidemiological analyses, and in practice through example implementation of a  autoregressive process.
...
Composable infectious disease modelling offers a path to maintain statistical rigour whilst enabling the rapid collaborative model development needed to inform policy decisions.
...
The proof of concept presented here shows that this approach is feasible but work remains to realise this potential.
