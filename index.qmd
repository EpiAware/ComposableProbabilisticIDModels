...
It should also be able to incorporate a range of domain expertise.
...
Cross-sectional viral load measurements have been shown to provide useful information on epidemic dynamics [@hay21_estimating], yet this cross-domain expertise has not been incorporated into most models used to inform policy even where such data was routinely available [@anderson20_reproduction; @ons2020cis].
Whilst multi-model efforts synthesise cross-domain expertise by combining forecasts or scenario projections from multiple teams (e.g., [@brisson20_impacthpv;@cramer22_unitedstatescovid]) and improve predictive accuracy [@reich22_collaborativehubs;@howerton23_evaluationuscovid], teams rarely collaborate on the components of their models despite shared goals, limiting how quickly evidence can be generated for new contexts.
