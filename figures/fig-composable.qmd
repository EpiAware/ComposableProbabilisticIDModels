...
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '64px', 'fontFamily': 'arial', 'lineColor': '#333'}, 'flowchart': {'diagramPadding': 60, 'htmlLabels': false, 'nodeSpacing': 40, 'rankSpacing': 40, 'padding': 40}}}%%
flowchart LR
    %% Class definitions
    classDef infection fill:#6fa8dc,stroke:#333,stroke-width:6px,color:black,padding:20px
    classDef latentInfection fill:#cfe2f3,stroke:#333,stroke-width:6px,color:black,padding:20px
    ...
    classDef sharedModel stroke:#6600cc,stroke-width:6px,stroke-dasharray:5 5,fill:#f3e5f5,color:black,padding:20px,font-weight:bold
    ...
    subgraph SharedModelsRow[" "]
        ...
        subgraph SharedCaseObs[" "]
            ...
            SCO_Input(["Symptom onsets"]):::latentInfection
        ...
        subgraph SharedViralKinetics[" "]
            ...
            SVK_RE(["Random Effect"]):::statistical
            SVK_Piecewise(["Piecewise Log-Linear"]):::statistical
            SVK_Infection(["Infection Time"]):::latentInfection
            SVK_VK(["Viral Kinetics"]):::infection
            SVK_VL(["Viral Load"]):::latentInfection

            SVK_RE ==> SVK_Piecewise
            SVK_Piecewise ==> SVK_VK
            SVK_Infection ==> SVK_VK
            SVK_VK ==> SVK_VL
        end
        ...
        subgraph SharedCol3[" "]
            ...
            subgraph SharedInfection[" "]
                ...
                SLI_Rt(["Time-varying Reproduction Number"]):::latentInfection
                SLI_GT(["Generation Time"]):::epiLatent
                SLI_Renewal(["Renewal Process"]):::infection
                SLI_Infections(["Infections"]):::latentInfection
            ...
            subgraph SharedIncubation[" "]
                ...
                SIP_Infections(["Infection times"]):::latentInfection
                SIP_Delay(["Delay"]):::observationModifier
                SIP_Onset(["Symptom onset times"]):::latentInfection
    ...
    subgraph ApplicationsRow[" "]
        ...
        subgraph Wastewater[" "]
            ...
            WW_Infections(["Infections"]):::latentInfection
            WW_ViralKineticsRef(["Viral Kinetics Model"]):::sharedModel
            WW_IncubationRef(["Incubation Period Model"]):::sharedModel
            WW_SheddingConv(["Shedding Convolution"]):::infection
            WW_EnvDeg(["Environmental Decay"]):::observationModifier
            WW_CalData(["Calibration Data"]):::epiLatent
            WW_ConcConv(["Viral Concentration Conversion"]):::transform
            WW_OM1(["Viral Concentration Data"]):::observationModel
            WW_CaseObsRef(["Case Observation Model"]):::sharedModel

            WW_InfectionRef ==> WW_Infections
            WW_Infections ==> WW_ViralKineticsRef
            WW_Infections ==> WW_SheddingConv
            WW_Infections ==> WW_IncubationRef
            WW_ViralKineticsRef ==> WW_SheddingConv
            WW_SheddingConv ==> WW_EnvDeg
            WW_EnvDeg ==> WW_ConcConv
            WW_CalData ==> WW_ConcConv
            WW_ConcConv ==> WW_OM1
        ...
        subgraph BiomarkerModelling[" "]
            ...
            BM_Infections(["Infections"]):::latentInfection
            BM_ViralKineticsRef(["Viral Kinetics Model"]):::sharedModel
            BM_IncubationRef(["Incubation Period Model"]):::sharedModel
            BM_CalData(["Calibration Data"]):::epiLatent
            BM_CtConv(["Cycle Threshold Conversion"]):::transform
            BM_OM1(["Cycle Threshold Values"]):::observationModel
            ...
            BM_ViralKineticsRef ==> BM_CtConv
            BM_CalData ==> BM_CtConv
            BM_CtConv ==> BM_OM1
        ...
        subgraph AppCol3[" "]
            ...
            subgraph EarlyOutbreak[" "]
                ...
                EOA_Infections(["Infections"]):::latentInfection
