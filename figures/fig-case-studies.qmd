...
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '64px', 'fontFamily': 'arial', 'lineColor': '#333'}, 'flowchart': {'htmlLabels': false, 'nodeSpacing': 80, 'rankSpacing': 80, 'padding': 40}}}%%
flowchart LR
    %% Class definitions
    ...
    subgraph Row1[" "]
        ...
        subgraph C[" "]
            ...
            direction LR
            C_ARIMA(["ARIMA"]):::sharedModel
            C_Broadcast(["Broadcast"]):::broadcast
            C_Weekly(["Weekly"]):::broadcast
            C_Exp(["Exp"]):::transform
            C_Rt(["Time-varying Reproduction Number"]):::latentInfection
            C_GT(["Generation Time"]):::epiLatent
            C_Renewal(["Renewal"]):::infection
            C_Infections(["Infections"]):::latentInfection
    ...
    subgraph Row2[" "]
        ...
        subgraph D[" "]
            ...
            D_Incidence(["Incidence"]):::latentInfection
            D_N(["Population"]):::epiLatent
            D_Softplus(["Softplus"]):::transform
            D_ScaleN(["Scale by Population"]):::observationModifier
        ...
        subgraph B[" "]
            ...
            B_Exp(["Exp"]):::transform
            B_Rt(["Time-varying Reproduction Number"]):::latentInfection
            B_GT(["Generation Time"]):::epiLatent
            B_Renewal(["Renewal"]):::infection
            B_Infections(["Infections"]):::latentInfection
        ...
        subgraph A[" "]
            A_Title(["ARIMA with Observation Error"]):::title
            direction TB

            subgraph A_ARIMA_Box[" "]
                direction TB
                A_ARIMA_Title(["ARIMA"]):::title
                subgraph A_ARMA_Box[" "]
                    direction TB
                    A_ARMA_Title(["ARMA"]):::title
    ...
    %% Style ARIMA nested boxes (shared model style - purple dashed)
    style A_ARIMA_Box fill:#f3e5f5,stroke:#6600cc,stroke-width:6px,stroke-dasharray:5 5
    style A_ARMA_Box fill:#f3e5f5,stroke:#6600cc,stroke-width:6px,stroke-dasharray:5 5
